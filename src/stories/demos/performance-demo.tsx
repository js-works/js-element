import { h, prop, sfc, slc, VNode } from '../../main/js-elements'
...
const SpeedTest = sfc('x-speed-test', {
  props: {
    columnCount: prop.num.opt(prefs.columnCount),
