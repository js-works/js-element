...
const Racket = component('x-racket', () => {
  const stateSel = useSelectors(StateSel)
...
const Scoreboard = component('x-scoreboard', () => {
  const stateSel = useSelectors(StateSel)
...
const CountdownPane = component('x-countdown-pane', () => {
...
const AlarmPane = component('x-alarm-pane', () => {
